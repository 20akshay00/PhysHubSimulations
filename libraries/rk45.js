...
exports.System.prototype = {
  ...
  setInitX: function(initX) {
    return this.x0 = initX;
  },
  setFn: function(fn_array) {
    return this.fn = fn_array;
  },
  setStart: function(start_time) {
    return this.start = start_time;
  },
  setStop: function(stop_time) {
    return this.stop = stop_time;
  },
  setH: function(h) {
    return this.h = h;
  },
